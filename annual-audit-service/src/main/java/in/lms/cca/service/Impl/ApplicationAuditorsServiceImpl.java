...
public class ApplicationAuditorsServiceImpl implements ApplicationAuditorsService {
	...
	@Override
	public List<ApplicationAuditorsEntity> getAllDataByAuditId(Long licenseeAuditId) {
		
		System.out.println("licenseeAuditId-=->"+licenseeAuditId);
		// TODO Auto-generated method stub
		return applicationAuditorsRepository.getAllDataByAuditId(licenseeAuditId);
	}
	...
	@Override
	public List<AuditCriteriaPayload> getAllData() {
	    String uriTemplate = apigatewayServiceUrl + "/admin-service/data";
