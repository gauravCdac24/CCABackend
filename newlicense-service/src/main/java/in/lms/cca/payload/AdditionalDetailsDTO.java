...
public class AdditionalDetailsDTO {
	...
	public void setBankDraftId(String bankDraftId) {
		...
		public String toString() {
			return "BankDraft [bankDraftId=" + bankDraftId + ", bankName=" + bankName + ", draftNo=" + draftNo
					+ ", issueDate=" + issueDate + ", intentId=" + intentId + ", amount=" + amount + ", status="
					+ status + ", createdBy=" + createdBy + ", updatedBy=" + updatedBy + ", created=" + created
					+ ", updated=" + updated + "]";
		}
