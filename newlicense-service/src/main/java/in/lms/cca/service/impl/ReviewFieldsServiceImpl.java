...
public class ReviewFieldsServiceImpl implements ReviewFieldsService {
	...
	@Override
	public ReviewFields findByReviewApplicationId(Long reviewId) {
		// TODO Auto-generated method stub
		return reviewFieldsRepository.findByReviewApplicationId(reviewId);
	}

	@Override
	public List<ReviewFields> finByReviewFieldsByApplicationId(Long reviewId) {
		// TODO Auto-generated method stub
		return reviewFieldsRepository. finByReviewFieldsByApplicationId(reviewId);
	}

	@Override
	public List<ReviewFields> reviewDatafields(Long reviewId) {
		// TODO Auto-generated method stub
		return reviewFieldsRepository.reviewDatafields(reviewId);
	}
