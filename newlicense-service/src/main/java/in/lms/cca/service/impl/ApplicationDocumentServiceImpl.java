...
public class ApplicationDocumentServiceImpl implements ApplicationDocumentService {
	...
	@Override
	public Optional<ApplicationDocument> findByAppDocId(String appDocId) {
		// TODO Auto-generated method stub
		return applicationDocumentRepo.findByAppDocId(appDocId);
	}

	@Override
	public List<ApplicationDocument> findIntentWithStatusAppById(Long intentAppId) {
		// TODO Auto-generated method stub
		return applicationDocumentRepo.findIntentWithStatusAppById(intentAppId);
	}
