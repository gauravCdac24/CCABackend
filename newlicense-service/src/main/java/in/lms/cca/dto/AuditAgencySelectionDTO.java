...
public class AuditAgencySelectionDTO {
    ...
    private String status;          // Status of the selection
    ...
    public String toString() {
        return "AuditAgencySelectionDTO{" +
                "agencySelectionId=" + agencySelectionId +
                ", auditAgencyId='" + auditAgencyId + '\'' +
                ...
                ", updatedBy='" + updatedBy + '\'' +
                ", status='" + status + '\'' +
                ", aplicantUserName='" + aplicantUserName + '\'' +
                '}';
    }
}
