...
@Entity
@Table(name = "ca_sw_web_main", schema="audit_management")
public class CaSwWebMain extends AbstractTimestampEntity {

    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    @Column(name = "ca_web_main_id", length = 11)
    private Long caWebMainId;
	...
	public Long getCaWebMainId() {
		return caWebMainId;
	}

	public void setCaWebMainId(Long caWebMainId) {
