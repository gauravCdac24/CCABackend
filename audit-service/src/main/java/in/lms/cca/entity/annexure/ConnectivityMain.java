...
@Entity
@Table(name = "connectivity_main", schema="audit_management")
public class ConnectivityMain extends AbstractTimestampEntity {

    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    @Column(name = "connectivity_main_id", length = 11)
    private Long connectivityMainId;
	...
	public Long getConnectivityMainId() {
		return connectivityMainId;
	}

	public void setConnectivityMainId(Long connectivityMainId) {
