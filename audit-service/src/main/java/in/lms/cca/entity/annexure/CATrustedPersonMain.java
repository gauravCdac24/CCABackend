...
@Entity
@Table(name = "ca_trusted_person_main", schema="audit_management")
public class CATrustedPersonMain extends AbstractTimestampEntity {

    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    @Column(name = "person_main_id", length = 11)
    private Long personMainId;
