...
@Entity
@Table(name = "audit_report_document",schema="audit_management")
...
public class AuditReportDocumentEntity extends AbstractTimestampEntity{
    ...
    @Column(name = "criteria_doc_id",length = 11)
	 ...
	 @ManyToOne(optional = false)
	    @JoinColumn(name = "app_audit_id", referencedColumnName = "app_audit_id", nullable = false)
	...
	@Column(name="status",length = 15)
		...
		public String toString() {
			return "AuditReportDocumentEntity [criteriaDocId=" + criteriaDocId + ", appAuditId=" + appAuditId
