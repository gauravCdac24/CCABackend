...
public class ApplicationAuditServiceImpl implements ApplicationAuditService {
	...
	@Override
	public Optional<ApplicationAuditEntity> addApplicationAudit(ApplicationAuditEntity applicationAuditEntity) {
		 if (applicationAuditEntity == null) {
	            return Optional.empty();
	        }

	        try {
	        	ApplicationAuditEntity savedApplicationAuditEntity = applicationAuditRepository.save(applicationAuditEntity);
	...
	@Override
	public ApplicationAuditEntity getByApplicantUserName(String ApplicantUserName) {
	...
	@Override
	public Optional<ApplicationAuditEntity> updateAuditor(ApplicationAuditEntity applicationAuditEntity) {
		if (applicationAuditEntity == null) {
            return Optional.empty();
        }
		
		if (applicationAuditEntity.getAppAuditId() == null) {
            return Optional.empty();
        }
	...
	@Override
	public List<ApplicationAuditEntity> getByApplicantUserNames(String applicantUserName) {
		// TODO Auto-generated method stub
	...
	@Override
	public Optional<ApplicationAuditEntity> updateData(ApplicationAuditEntity auditEntity) {
		 if (auditEntity == null) {
	            return Optional.empty();
	        }
		 
		 if (auditEntity.getAppAuditId() == null) {
	            return Optional.empty();
	        }

	        try {
	        	ApplicationAuditEntity savedApplicationAuditEntity = applicationAuditRepository.save(auditEntity);
	            return Optional.of(savedApplicationAuditEntity);
	        } catch (Exception e) {
	            return Optional.empty();
	        }
	...
	@Override
	public ApplicationAuditEntity getAuditDetailsById(Long appAuditId) {
		// TODO Auto-generated method stub
	...
	@Override
	public List<ApplicationAuditEntity> getAll() {
		// TODO Auto-generated method stub
	...
	@Override
	public void changedApplicantStatus(String applicantUserName) {
		  String uriTemplate = apigatewayServiceUrl + "/newlicense-service/change-applicants-status-by-username/{applicantUserName}";
	...
	@Override
	public void changedApplicantStatusByAuditor(String applicantUserName) {
		  String uriTemplate = apigatewayServiceUrl + "/newlicense-service/change-auditor-status-by-username/{applicantUserName}";
	...
	@Override
	public void acceptApplicantStatusByAuditor(String applicantUserName) {
		  String uriTemplate = apigatewayServiceUrl + "/newlicense-service/accept-auditor-status-by-username/{applicantUserName}";
