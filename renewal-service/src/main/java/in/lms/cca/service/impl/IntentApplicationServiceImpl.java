...
public class IntentApplicationServiceImpl implements IIntentApplicationService{
	...
	public IntentApplication findIntentAppById(String userName) {
		...
		return intentAppRepo.findIntentAppById(userName);
	}

	@Override
	public Long addUser(LocationDetailsPayload locationDetailsPayload) {
	...
	@Override
	public List<IntentApplication> getAllIntentApplicationByApplicantUserName(String aplicantUserName) {
		// TODO Auto-generated method stub
		return intentAppRepo.getAllIntentApplicationByApplicantUserName(aplicantUserName);
	}
}
