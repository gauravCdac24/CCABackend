...
@Entity
@Table(name = "indiv_services", schema = "new_license_management")
public class IndivServices extends AbstractTimestampEntity {

    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    @Column(name = "indiv_service_id", length = 11)
    private Long indivServiceId;
	...
	public Long getIndivServiceId() {
		return indivServiceId;
	}

	public void setIndivServiceId(Long indivServiceId) {
		this.indivServiceId = indivServiceId;
	}
