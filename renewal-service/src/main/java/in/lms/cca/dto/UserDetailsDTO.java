...
public class UserDetailsDTO {
		...
		public String toString() {
			return "UserDetailsDTO [salutation=" + salutation + ", firstName=" + firstName + ", middleName="
					...
					+ ", fatherLastName=" + fatherLastName + ", bankName=" + bankName + ", branch=" + branch
					+ ", accountType=" + accountType + ", accountNo=" + accountNo + ", draftBankName=" + draftBankName
					+ ", draftNo=" + draftNo + ", draftAmount=" + draftAmount + ", draftIssueDate=" + draftIssueDate
					+ ", residentialBlockNo=" + residentialBlockNo + ", residentialVillage=" + residentialVillage
					+ ", residentialPostOffice=" + residentialPostOffice + ", residentialSubDivision="
					+ residentialSubDivision + ", residentialCountry=" + residentialCountry + ", residentialState="
					+ residentialState + ", residentialCity=" + residentialCity + ", residentialPin=" + residentialPin
					+ ", residentialTelephoneNo=" + residentialTelephoneNo + ", residentialFax=" + residentialFax
					+ ", residentialMobile=" + residentialMobile + ", officialBlockNo=" + officialBlockNo
					+ ", officialVillage=" + officialVillage + ", officialPostOffice=" + officialPostOffice
					+ ", officialSubDivision=" + officialSubDivision + ", officialCountry=" + officialCountry
					+ ", officialState=" + officialState + ", officialCity=" + officialCity + ", officialPin="
					+ officialPin + ", officialTelephoneNo=" + officialTelephoneNo + ", officialFax=" + officialFax
					+ ", creditCardType=" + creditCardType + ", creditCardNo=" + creditCardNo + ", issuedBy=" + issuedBy
					+ ", ispName=" + ispName + ", ispWebsiteAddress=" + ispWebsiteAddress + ", ispUserName="
					+ ispUserName + ", webPageURL=" + webPageURL + ", passportNo=" + passportNo
					+ ", passportIssuingAuthority=" + passportIssuingAuthority + ", passportExpiryDate="
					+ passportExpiryDate + ", file1=" + file1 + ", file2=" + file2 + ", file3=" + file3 + ", file4="
					+ file4 + ", voterIdNo=" + voterIdNo + ", incomeTaxPanNo=" + incomeTaxPanNo + ", capital=" + capital
					+ ", remarks=" + remarks + ", userName=" + userName + ", reviewerUserName=" + reviewerUserName
					+ "]";
		}
